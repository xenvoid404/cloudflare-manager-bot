...
class Messages:
    ...
    class Common:
        ...
        ERROR_GENERIC = f"{Emojis.ERROR} Terjadi kesalahan. Gunakan /menu untuk mencoba lagi."
        LOADING = f"{Emojis.LOADING} Memproses permintaan Anda...\nMohon tunggu sebentar."
...
Gunakan /menu untuk mengakses menu utama.
    ...
    class Validation:
        ...
        INVALID_SELECTION = f"{Emojis.WARNING} Pilihan tidak valid. Gunakan /menu untuk mencoba lagi."
        ZONE_NOT_FOUND = f"{Emojis.WARNING} Zone tidak ditemukan. Gunakan /menu untuk mencoba lagi."
